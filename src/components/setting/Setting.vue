<template>
  <div class="side-setting">
    ...
    <setting-item :title="$t('theme.color')">
      ...
      <div>
        <a-form :style="{ marginTop: '10px' }" layout="inline" :form="form" @submit="() => setTheme({ ...theme, color: themeColor })">
          <a-form-item>
            <a-input :style="{ width: '60px' }" type="color" @change="themeColorChange" />
          </a-form-item>
          <a-form-item>
            <a-button type="primary" html-type="submit" :disabled="!themeColor">确定</a-button>
          </a-form-item>
        </a-form>
      </div>
    </setting-item>
